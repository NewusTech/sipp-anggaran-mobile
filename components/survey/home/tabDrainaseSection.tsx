...
import SectionCardDrainase from './SectionDrainaseCard';
import SectionMapDrainase from './SectionDrainaseMap';
import SectionTableDrainase from './SectionTableDrainase';

export default function TabSectionDrainase() {
