...
import SectionCardSurvey from './SectionCard';
import SectionMapRoad from './SectionRoadMap';
import SectionTableSurvey from './SectionTable';

export default function TabSectionRoad() {
